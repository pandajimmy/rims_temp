...
path('mc_design_template/', include('_mc_design_template.urls')),
    ...
    path('mc_tta_list_purchase_n_rebates/', include('_mc_tta_list_purchase_n_rebates.urls')),
    path('mc_tta_list_payment_n_discount/', include('_mc_tta_list_payment_n_discount.urls')),
    path('mc_tta_list_stock_n_deliveries/', include('_mc_tta_list_stock_n_deliveries.urls')),
    path('mc_tta_list_administration_fees/', include('_mc_tta_list_administration_fees.urls')),
    path('mc_tta_list_business_growth_support/', include('_mc_tta_list_business_growth_support.urls')),
    path('mc_tta_list_promotion_support/', include('_mc_tta_list_promotion_support.urls')),
    path('mc_tta_list_display_incentive/', include('_mc_tta_list_display_incentive.urls')),
    path('mc_tta_list_display_incentive_table/', include('_mc_tta_list_display_incentive_table.urls')),
    path('mc_tta_list_marketing_support/', include('_mc_tta_list_marketing_support.urls')),
    path('mc_tta_list_e_commerce_support/', include('_mc_tta_list_e_commerce_support.urls')),
    path('mc_tta_list_condition_of_trade/', include('_mc_tta_list_condition_of_trade.urls')),
    path('mc_tta_list_trading_brand/', include('_mc_tta_list_trading_brand.urls')),
    path('mc_tta_list_trading_group/', include('_mc_tta_list_trading_group.urls')),
    path('mc_tta_list_outlet/', include('_mc_tta_list_outlet.urls')),
    path('mc_tta_list_exclude_outlet/', include('_mc_tta_list_exclude_outlet.urls')),
