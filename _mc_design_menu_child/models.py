...
class DesignMenuChild(models.Model):
    design_menu_guid = models.ForeignKey(DesignMenu, models.DO_NOTHING, db_column='design_menu_guid',related_name='sub_menu', verbose_name='Design Menu Globally Unique Identifier')
    design_menu_child_guid = models.CharField(primary_key=True, max_length=32, verbose_name='Design Menu Child Globally Unique Identifier')
