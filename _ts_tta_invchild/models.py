...
class TtaInvchild(models.Model):
    ...
    first_cal_date = models.DateField(blank=True, null=True, verbose_name='First Calculation Date')    
    last_cal_date = models.DateField(blank=True, null=True, verbose_name='Last Calculation Date')    
    total_year = models.IntegerField(blank=True, null=True, verbose_name='Total Year')
    total_month = models.IntegerField(blank=True, null=True, verbose_name='Total Month')
