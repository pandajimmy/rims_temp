...
class TtaListConditionOfTrade(models.Model):
    ...
    customer_guid = models.OneToOneField(CustomerProfile, on_delete=models.DO_NOTHING, db_column='customer_guid', verbose_name='Customer guid', related_name='tta_condition_of_trade_customer_profile')
