...
class DesignMainTemplateViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = DesignMainTemplate.objects.all().order_by('main_description')
    serializer_class = DesignMainTemplateSerializer
    filter_backends = (django_filters.rest_framework.DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter,)
    filterset_fields = ['main_name','main_description','customer_guid'] 
    search_fields = ['main_description']	