...
class DesignMainTemplate(models.Model):
    customer_guid = models.ForeignKey(CustomerProfile, on_delete=models.DO_NOTHING, db_column='customer_guid', verbose_name='Customer guid', related_name='design_main_template_option_customer_profile')
    ...
    class Meta:
        ...
        ordering = ('main_description',)

    def __str__(self):
        return self.main_description

    def get_absolute_url(self):
        return f'/{self.main_description}/' 