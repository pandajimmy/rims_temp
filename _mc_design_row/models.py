...
class DesignRow(models.Model):
    tab_guid = models.ForeignKey(DesignTab, models.DO_NOTHING, db_column='tab_guid',related_name='rows', verbose_name='Tab guid')
    row_guid = models.CharField(primary_key=True, max_length=32, verbose_name='Row guid')
